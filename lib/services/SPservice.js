...
var SPService = (function () {
     ...
     *
     */
    SPService.prototype.getListItems = function (filterText, listId, internalColumnName, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var filter, returnItems, spWeb, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filter = "startswith(" + internalColumnName + ",'" + filterText + "')";
                        console.log("Page context url " + this._context.pageContext.web.absoluteUrl);
                    ...
                    case 2:
                        returnItems = _a.sent();
                        return [2 /*return*/, Promise.resolve(returnItems)];
                    case 3:
                        error_1 = _a.sent();
    ...
    SPService.prototype.getListItemAttachments = function (listId, itemId, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var returnFiles, spWeb, files, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (typeof webUrl === undefined) {
                    ...
                    case 2:
                        files = _a.sent();
                        return [2 /*return*/, Promise.resolve(files)];
                    case 3:
                        error_2 = _a.sent();
