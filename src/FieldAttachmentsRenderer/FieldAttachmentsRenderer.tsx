  ...
  private  previewImages : any[];
   ...
   private async _loadAttachments() {
    ...
    private _onDeleteAttachment(_file: any) {
        ...
        // Delete Attachment
        let item = pnp.sp.web.lists.getById(this.props.ListGuid).items.getById(this.props.RaidId);

        item.attachmentFiles.getByName(_file)
            .delete()
            .then(v => {
